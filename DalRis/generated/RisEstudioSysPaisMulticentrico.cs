...
namespace DalRis
{
	...
	public partial class RisEstudioSysPaisMulticentrico : ActiveRecord<RisEstudioSysPaisMulticentrico>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("RIS_EstudioSysPaisMulticentrico", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("RIS_EstudioSysPaisMulticentrico",schema);
			}
		}
		#endregion
